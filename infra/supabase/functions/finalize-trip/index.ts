...
async function finalizeOne(
    ...
    // Pick the first piece as a representative polyline. We deliberately do
    // NOT concatenate disparate segments into one polyline — that would imply
    // continuous geometry across actual outages. Storing the first segment is
    // enough for debugging; full segment-by-segment polylines can be added if
    // ever needed in admin diagnostics.
